...
negative_tags = [(False, 'Graffiti', "Sokak sanatı"),
                 (True, 'Narrow', "Sıkışık"),
                 (False, 'Human', "İnsan"),
                 ...
                 (True, 'Deserted', "Terk edilmiş yer"),
                 (False, 'Car', "Araba"),
                 (True, 'Other', "Diğer")
                 ]
positive_tags = [(False, 'Tree', "Ağaç"),
                 (True, 'Scenery', "Manzara"),
                 (False, 'Seaside/Waterways', "Deniz/kanal"),
                 (True, 'Human', "İnsan"),
                 (False, 'Landmark', "Kilise/Anıt"),
...
questions_multiple_answers = {1: ['Birinci kat kullanımı',
                              ...
                              22: ['Kamusal Alan',
                                   ...
                                   "Public space usage",False,
                                   22],
                              23: ['Topluluk',
                                   'Evaluate the density of people interacting and spending time in the open area on the street in the image.',
                                   'Görseldeki sokakta açık alanda etkileşimde olan ve vakit geçiren insan yoğunluğunu değerlendiriniz?',"Community",
                                   False,
                                   23],
                              24: ['Trafik Yoğunluğu',
                                   'What is the traffic volume on the street in the image?',
                                   'Görselde cadde üzerindeki trafik yoğunluğunu değerlendiriniz',"Traffic Volume",
                                   False,
                                   24]}